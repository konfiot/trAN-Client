...
${OBJECTDIR}/socket.o: socket.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O3 -MMD -MP -MF $@.d -o ${OBJECTDIR}/socket.o socket.c

${OBJECTDIR}/manipulation_dossiers.o: manipulation_dossiers.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O3 -MMD -MP -MF $@.d -o ${OBJECTDIR}/manipulation_dossiers.o manipulation_dossiers.c

${OBJECTDIR}/divers.o: divers.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O3 -MMD -MP -MF $@.d -o ${OBJECTDIR}/divers.o divers.c
...
${OBJECTDIR}/transmission.o: transmission.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O3 -MMD -MP -MF $@.d -o ${OBJECTDIR}/transmission.o transmission.c

${OBJECTDIR}/copie.o: copie.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O3 -MMD -MP -MF $@.d -o ${OBJECTDIR}/copie.o copie.c
